...
public class BooksReportController {
	...
	/**
	 * Creates a new BooksReportController. Sets cancelClicked to false.
	 */
	public BooksReportController(){
		cancelClicked = false; 
	}
	...
	public void setMain(Main main){
		...
		for(int i = 0; i < numBooks; i++){ //copies data to books to avoid passing by reference
			booksOut.add(main.getBooksOutData().get(i)); 
		} 
